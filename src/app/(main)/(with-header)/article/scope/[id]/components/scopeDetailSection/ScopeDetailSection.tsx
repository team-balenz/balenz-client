...
import ArticleDetailThumbnail from '@/app/(main)/(with-header)/article/components/articleDetailThumbnail/ArticleDetailThumbnail';
...
import ArticleDetailFooter from '@/app/(main)/(with-header)/article/components/articleDetailFooter/ArticleDetailFooter';
