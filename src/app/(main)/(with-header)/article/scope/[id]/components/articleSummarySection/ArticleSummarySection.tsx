...
import { SUMMARY_CATEGORY_TABS } from '@/app/(main)/(with-header)/(home)/constants';
import { type ArticleSummarySectionTypes } from '@/app/(main)/(with-header)/article/scope/[id]/types/articleSummarySection';
